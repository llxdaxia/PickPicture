...
class Conf
{
    ...
    public static $APPID = '1007268';
    public static $SECRET_ID = 'AKIDol3hHtHrhSZuDCFSCEr0DQCBoyBDlOEf';
    public static $SECRET_KEY = '55jtu8MH5BNHl9gPgDQLTc9NPRpmaiJ1';
    public static $END_POINT = 'http://api.youtu.qq.com/';

    
    // 开发者 QQ
    public static $USER_ID = '973829691';
